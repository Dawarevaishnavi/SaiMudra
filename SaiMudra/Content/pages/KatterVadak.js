...
var KatterVadakList = function () {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var html = "";
            $("#tblKattarVadak").empty();
            $.each(response.model, function (index, elementValue) {

                html += "<div class='col - md-4col-sm-8'>";
                html += "<div id='serv_hover' class='room'>";
                html += " <div class='room_img'>";
                html += "<figure><img src='../Content/Img/ " + elementValue.Photo + "' alt='#' /></figure>";
                html += "</div>";
                html += "<div class='bed_room'>";
                html += "<span class='ClsName'>";
                html += " Prajwal Gode";
                html += "<a href='" + elementValue.Instragram + "'><ion-icon name='logo-instagram' class='logo1'></ion-icon></a>";
                html += "<a href='" + elementValue.Facebook + "'><ion-icon name='logo-facebook' class='logo2'></ion-icon></a>";
                html += "</span>";
                html += "</div>";
                html += "</div>";
                html += "</div>";
